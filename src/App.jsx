    ...
    <>
      <main>
        ...
        <section id='section-3' >
          <div className='top'>
            <div className="left">
              <h1>Let’s work together <br/> and make everything <br/>happen in the <br/> right way</h1>
            </div>
            <div className="right">
              <p>
          ...
          <div className='bottom'>
            ...
            <div className="right">
              <p>Interested in working with us? <br />
                Reach out to discuss a project, <br />
                collaboration or just to say duck off.
                <br/>Let's not just yap related to project but <br/> make real things happen.
                First  and foremost thing is, <br/> we don't build to just deploy.<br/> We build to win </p>
             </div>
          </div>
        </section>
      </main>
